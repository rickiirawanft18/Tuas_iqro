...
public class TutorActivity extends Activity implements OnClickListener {
	...
	private void populateTutorList()
	{
		...
		t1.setSound(R.raw.ain);
		t1.setTitle("Bibir terbuka lebar");
		t1.setText("Di ucapkan dengan jelas, di tenggorokan terjauh");
		...
		t3.setSound(R.raw.tsa);
		t3.setTitle("Bibir terbuka lebar");
		t3.setText("Menyentuh ujung lidah ke gusi gigi seri atas");
		
		Tutor t4 = new Tutor();
		t4.setHijaiyah("ث");
		t4.setImg(R.drawable.tutor_4);
		t4.setSound(R.raw.tsa);
